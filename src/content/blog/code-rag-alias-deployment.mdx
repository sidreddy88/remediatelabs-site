...
*Part 8 of the Code RAG series. Parts 1–7 built a RAG pipeline that indexes correctly and stays fresh. This post covers the one operational problem that none of that solves: what happens to live queries while you're rebuilding the index.*
