...
Incident RAG has it easy. Each document is a purpose-built retrieval target — a formatted string like:
...
One incident, one text, written in natural language about what went wrong. The document was designed to be found.
